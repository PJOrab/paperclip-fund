...
def build_adapters():
    ...
    adapters = [
        ...
        ("Analyst Consensus", S.AnalystConsensusAdapter()),
        ("Gov Contracts", S.GovContractsAdapter()),
        ("Job Postings", S.JobPostingsAdapter()),
        ...
        ("Institutional 13F", S.InstitutionalHoldingsAdapter()),
        ("Semi Equipment Bookings", S.SemiEquipmentBookingsAdapter()),
    ]
